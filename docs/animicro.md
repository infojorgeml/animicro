...
**Release:** 1.18.0 (2026-05-13). See CHANGELOG for history.
...
- **Modules**: `fade`, `slide-up`, `slide-down`, `slide-left`, `slide-right`, `skew-up`, `scale`, `blur`, `float`, `pulse`, `hover-zoom`, `spin`, `stagger`, `grid-reveal`, `highlight`, `text-fill-scroll`, `parallax`, `img-parallax`, `magnet`, `split`, `scatter`, `scramble`, `text-reveal`, `typewriter`, `page-curtain`. Each exports `init()`.
