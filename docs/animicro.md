...
3. En su builder, añade clases como `.am-fade` a elementos y atributos como `data-am-delay="0.2"`.
4. Si un módulo está desactivado, su JS/CSS no carga.
5. Prioridad en atributos: Atributos individuales (ej. `data-am-duration`) sobrescriben globales.
...
- Lógica de Atributos: Leer `data-am-*` individuales; fallback a globales.
