...
class Animicro_License_Manager {
	...
	const PRO_MODULES  = [ 'blur', 'stagger', 'grid-reveal', 'text-fill-scroll', 'parallax', 'split', 'text-reveal', 'img-parallax', 'magnet', 'scatter', 'scramble', 'spin', 'clip-reveal', 'magnetic', 'cursor' ];
